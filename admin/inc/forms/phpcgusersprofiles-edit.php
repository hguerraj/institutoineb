...
if (!isset($_SESSION['errors']['form-edit-phpcg-users-profiles']) || empty($_SESSION['errors']['form-edit-phpcg-users-profiles'])) { // If no error registered
    ...
    $_SESSION['form-edit-phpcg-users-profiles']['r_alumnos'] = $row->r_alumnos;
    $_SESSION['form-edit-phpcg-users-profiles']['u_alumnos'] = $row->u_alumnos;
    $_SESSION['form-edit-phpcg-users-profiles']['cd_alumnos'] = $row->cd_alumnos;
    $_SESSION['form-edit-phpcg-users-profiles']['cq_alumnos'] = $row->cq_alumnos;
    $_SESSION['form-edit-phpcg-users-profiles']['r_carreras'] = $row->r_carreras;
    $_SESSION['form-edit-phpcg-users-profiles']['u_carreras'] = $row->u_carreras;
    $_SESSION['form-edit-phpcg-users-profiles']['cd_carreras'] = $row->cd_carreras;
    $_SESSION['form-edit-phpcg-users-profiles']['cq_carreras'] = $row->cq_carreras;
    $_SESSION['form-edit-phpcg-users-profiles']['r_cursos'] = $row->r_cursos;
    $_SESSION['form-edit-phpcg-users-profiles']['u_cursos'] = $row->u_cursos;
    $_SESSION['form-edit-phpcg-users-profiles']['cd_cursos'] = $row->cd_cursos;
    $_SESSION['form-edit-phpcg-users-profiles']['cq_cursos'] = $row->cq_cursos;
    $_SESSION['form-edit-phpcg-users-profiles']['r_grados'] = $row->r_grados;
    $_SESSION['form-edit-phpcg-users-profiles']['u_grados'] = $row->u_grados;
    $_SESSION['form-edit-phpcg-users-profiles']['cd_grados'] = $row->cd_grados;
    $_SESSION['form-edit-phpcg-users-profiles']['cq_grados'] = $row->cq_grados;
    $_SESSION['form-edit-phpcg-users-profiles']['r_grados_secciones'] = $row->r_grados_secciones;
    $_SESSION['form-edit-phpcg-users-profiles']['u_grados_secciones'] = $row->u_grados_secciones;
    $_SESSION['form-edit-phpcg-users-profiles']['cd_grados_secciones'] = $row->cd_grados_secciones;
    $_SESSION['form-edit-phpcg-users-profiles']['cq_grados_secciones'] = $row->cq_grados_secciones;
    $_SESSION['form-edit-phpcg-users-profiles']['r_inscripciones'] = $row->r_inscripciones;
    $_SESSION['form-edit-phpcg-users-profiles']['u_inscripciones'] = $row->u_inscripciones;
    $_SESSION['form-edit-phpcg-users-profiles']['cd_inscripciones'] = $row->cd_inscripciones;
    $_SESSION['form-edit-phpcg-users-profiles']['cq_inscripciones'] = $row->cq_inscripciones;
    $_SESSION['form-edit-phpcg-users-profiles']['r_notas'] = $row->r_notas;
    $_SESSION['form-edit-phpcg-users-profiles']['u_notas'] = $row->u_notas;
    $_SESSION['form-edit-phpcg-users-profiles']['cd_notas'] = $row->cd_notas;
    $_SESSION['form-edit-phpcg-users-profiles']['cq_notas'] = $row->cq_notas;
    $_SESSION['form-edit-phpcg-users-profiles']['r_padres_encargados'] = $row->r_padres_encargados;
    $_SESSION['form-edit-phpcg-users-profiles']['u_padres_encargados'] = $row->u_padres_encargados;
    $_SESSION['form-edit-phpcg-users-profiles']['cd_padres_encargados'] = $row->cd_padres_encargados;
    $_SESSION['form-edit-phpcg-users-profiles']['cq_padres_encargados'] = $row->cq_padres_encargados;
    $_SESSION['form-edit-phpcg-users-profiles']['r_pagos'] = $row->r_pagos;
    $_SESSION['form-edit-phpcg-users-profiles']['u_pagos'] = $row->u_pagos;
    $_SESSION['form-edit-phpcg-users-profiles']['cd_pagos'] = $row->cd_pagos;
    $_SESSION['form-edit-phpcg-users-profiles']['cq_pagos'] = $row->cq_pagos;
    $_SESSION['form-edit-phpcg-users-profiles']['r_profesores'] = $row->r_profesores;
    $_SESSION['form-edit-phpcg-users-profiles']['u_profesores'] = $row->u_profesores;
    $_SESSION['form-edit-phpcg-users-profiles']['cd_profesores'] = $row->cd_profesores;
    $_SESSION['form-edit-phpcg-users-profiles']['cq_profesores'] = $row->cq_profesores;
    $_SESSION['form-edit-phpcg-users-profiles']['r_unidades'] = $row->r_unidades;
    $_SESSION['form-edit-phpcg-users-profiles']['u_unidades'] = $row->u_unidades;
    $_SESSION['form-edit-phpcg-users-profiles']['cd_unidades'] = $row->cd_unidades;
    $_SESSION['form-edit-phpcg-users-profiles']['cq_unidades'] = $row->cq_unidades;
