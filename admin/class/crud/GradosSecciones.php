...
class GradosSecciones extends Elements
{
    ...
    public $ID = array();
    public $Nombre_Grado = array();
    public $nombre_seccion = array();
    public $Nivel_Educativo = array();
    ...
    public function __construct($element, $params = array())
    {
        ...
        $this->join_query = ' LEFT JOIN grados ON grados_secciones.Grado_ID=grados.ID';
        $columns = 'grados_secciones.ID, grados_secciones.Nombre_Grado, grados_secciones.nombre_seccion, grados_secciones.Nivel_Educativo, grados.ID AS gra_ID';
        $where = array();
        ...
        $this->main_pdo_settings = array(
            'function' => 'select',
            'from'    => 'grados_secciones' . $active_filters_join_queries,
            'values'   => $columns,
            'where'    => $where,
        ...
        if (!empty($this->records_count)) {
            while ($row = $db->fetch()) {
                ...
                $this->ID[] = $row->ID;
                $this->Nombre_Grado[] = $row->Nombre_Grado;
                $this->nombre_seccion[] = $row->nombre_seccion;
                $this->Nivel_Educativo[] = $row->Nivel_Educativo;
