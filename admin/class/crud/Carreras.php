...
class Carreras extends Elements
{
    ...
    public function __construct($element, $params = array())
    {
        ...
        $columns = 'carreras.ID, carreras.Nombre_Carrera, carreras.descripcion';
        $where = array();
        ...
        // order query
        $this->sorting = ElementsUtilities::getSorting($table, 'Nombre_Carrera', 'ASC');
        ...
        $this->main_pdo_settings = array(
            'function' => 'select',
            'from'    => 'carreras' . $active_filters_join_queries,
            'values'   => $columns,
            'where'    => $where,
