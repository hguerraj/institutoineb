...
class Pagos extends Elements
{
    ...
    public $Tipo_Pago = array();
    public $Monto = array();
    public $Fecha_Pago = array();
    public $anio = array();
    public $Mes = array();
    ...
    public function __construct($element, $params = array())
    {
        ...
        $this->join_query = ' LEFT JOIN alumnos ON pagos.Alumno_ID=alumnos.ID';
        $columns = 'pagos.ID, alumnos.ID AS alu_ID, pagos.Tipo_Pago, pagos.Monto, pagos.Fecha_Pago, pagos.anio, pagos.Mes, pagos.Estado_Pago';
        $where = array();
        ...
        $this->main_pdo_settings = array(
            'function' => 'select',
            'from'    => 'pagos' . $active_filters_join_queries,
            'values'   => $columns,
            'where'    => $where,
