...
class Grados extends Elements
{
    ...
    public function __construct($element, $params = array())
    {
        ...
        $this->join_query = ' LEFT JOIN carreras ON grados.Carrera_ID=carreras.ID';
        $columns = 'grados.ID, grados.Nombre_Grado, grados.descripcion, carreras.ID AS car_ID';
        $where = array();
        ...
        $this->main_pdo_settings = array(
            'function' => 'select',
            'from'    => 'grados' . $active_filters_join_queries,
            'values'   => $columns,
            'where'    => $where,
