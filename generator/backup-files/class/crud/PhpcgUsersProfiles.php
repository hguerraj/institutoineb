...
class PhpcgUsersProfiles extends Elements
{
    ...
    public function __construct($element, $params = array())
    {
        ...
        $columns = 'phpcg_users_profiles.id, phpcg_users_profiles.profile_name, phpcg_users_profiles.r_carreras, phpcg_users_profiles.u_carreras, phpcg_users_profiles.cd_carreras, phpcg_users_profiles.cq_carreras, phpcg_users_profiles.r_grados, phpcg_users_profiles.u_grados, phpcg_users_profiles.cd_grados, phpcg_users_profiles.cq_grados, phpcg_users_profiles.r_phpcg_users, phpcg_users_profiles.u_phpcg_users, phpcg_users_profiles.cd_phpcg_users, phpcg_users_profiles.cq_phpcg_users, phpcg_users_profiles.r_phpcg_users_profiles, phpcg_users_profiles.u_phpcg_users_profiles, phpcg_users_profiles.cd_phpcg_users_profiles, phpcg_users_profiles.cq_phpcg_users_profiles';
        $where = array();
